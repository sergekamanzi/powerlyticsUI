...
const Contact = () => {
  ...
  'section',
  { id: 'contact', className: 'contact-page', 'data-reveal': 'up' },

    // ===== Top CTA =====
    React.createElement(
  'div',
  { className: 'contact-hero', 'data-reveal': 'left' },
      React.createElement(
        'h2',
        null,
    ...
    React.createElement(
  'div',
  { className: 'contact-map-wrap', 'data-reveal': 'right', style: { '--reveal-delay': '120ms' } },
      ...
      React.createElement(
  'aside',
  { className: 'contact-card', 'aria-label': 'Contact Details', 'data-reveal': 'up', style: { '--reveal-delay': '220ms' } },
        React.createElement(
          'div',
