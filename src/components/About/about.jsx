...
const About = () => {
  ...
  'div',
  { id: 'why-us', className: 'main-about', 'data-reveal': 'up' },
    React.createElement(
  'div',
  { className: 'stats-container', 'data-reveal': 'up' },
      React.createElement(
  'div',
  { className: 'about-icons' },
        React.createElement(
          'div',
          { className: 'stat-item', 'data-reveal': 'left' },
        ...
        React.createElement(
          'div',
          { className: 'stat-item', 'data-reveal': 'right', style: { '--reveal-delay': '80ms' } },
        ...
        React.createElement(
          'div',
          { className: 'stat-item', 'data-reveal': 'left', style: { '--reveal-delay': '160ms' } },
        ...
        React.createElement(
          'div',
          { className: 'stat-item', 'data-reveal': 'right', style: { '--reveal-delay': '240ms' } },
  ...
  { className: 'about-content' },
      React.createElement(
  'div',
  { className: 'about-description', 'data-reveal': 'left' },
      ...
      React.createElement(
  'div',
  { className: 'about-image', 'data-reveal': 'right' },
